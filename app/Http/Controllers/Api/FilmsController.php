...
class FilmsController extends Controller
{
    ...
    public function comment($film_id)
    {
        ...
        if ($validator->fails()) {
            ...
            $comment->author_name = Input::get('author_name');
